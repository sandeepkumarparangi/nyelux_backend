...
echo "=== Nyelux Backend Server Restart ==="
echo ""
...
echo "- Local DB: Users, auth, organizations (private data)"
echo "- Link: gudid_primary_di field"
echo ""
echo "New Features Fixed:"
echo "✅ /api/v1/public/track-search endpoint added"
echo "✅ Search analytics tracking enabled"
echo "✅ Lead capture after 3 searches"
echo ""
