#!/usr/bin/env python3
"""
Test script for the public track-search endpoint
"""
import requests
import json
...
def test_track_search():
    """Test the track-search endpoint"""
    print("\n2. Testing track-search endpoint...")
...
def test_public_search():
    ...
    # Try with a test API key (might fail if not configured)
    headers = {
...
def main():
    print("="*60)
    print("NYELUX BACKEND TEST - Public Search Tracking")
    print("="*60)
